...
var paths = {
    ...
    libTargetPrimeng: "scripts/primeng/"
...
gulp.task('copy-libs', function () {
    ...
    gulp.src("node_modules/primeng/**/*.js").pipe(gulp.dest(paths.libTargetPrimeng));
    gulp.src("node_modules/primeng/**/*.css").pipe(gulp.dest(paths.libTargetPrimeng));
